...
func TestProgressBarChunkIndex(t *testing.T) {
	...
	tests := []chunkTest{
		...
		{deltaSecond: 1.5, wantIndex: 0},
		{deltaSecond: 1.51, wantIndex: 1},
		{deltaSecond: 2.0, wantIndex: 1},
		{deltaSecond: 3.0, wantIndex: 1},
		{deltaSecond: 3.01, wantIndex: 2},
		{deltaSecond: 4.0, wantIndex: 2},
		{deltaSecond: 4.4, wantIndex: 2},
		{deltaSecond: 4.5, wantIndex: 2},
		{deltaSecond: 5.0, wantIndex: 3},
		{deltaSecond: 6.0, wantIndex: 3},
		{deltaSecond: 7.0, wantIndex: 4},
		{deltaSecond: 7.5, wantIndex: 4},
		{deltaSecond: 7.6, wantIndex: 5},
		{deltaSecond: 8.0, wantIndex: 5},
		{deltaSecond: 8.9, wantIndex: 5},
		{deltaSecond: 9.01, wantIndex: 6},
		{deltaSecond: 27.0, wantIndex: 17},
		{deltaSecond: 27.01, wantIndex: 18},
		{deltaSecond: 28.5, wantIndex: 18},
		{deltaSecond: 28.51, wantIndex: 19},
		{deltaSecond: 29.9, wantIndex: 19},
		{deltaSecond: 30.0, wantIndex: 19},
		{deltaSecond: 30.01, wantIndex: 19},
	}
